...
# Safe Use Disclaimer
## Templates
A recommendation is to save your template in a text document before doing anything. Default templates syntax are accessible on the [note template page from Zotero documentation](https://www.zotero.org/support/note_templates) anyway.
...
* I wrote this repo as an side project on my own and declare that I do not have interest in any specific organization. 
* Part of all this is made of master's thesis procrastination. But it is also grounded in some years of annotating practices and academia writing. I started to use Zotero around 2021 when the reader was in betatesting.
